...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toggleButton = findViewById(R.id.favouritButton);
        ...
        toggleButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checked) {
                    Log.e("DetailActivity", "insert id " + moviesConverter.getId());
    ...
    public void observe(MovieViewModel viewModel, final int id) {
        Log.e("DetailActivity", "observe search id " + id);
        ...
        viewModel.getAllMovies().observe(this, new Observer<List<MoviesConverter>>() {
            ...
            public void onChanged(List<MoviesConverter> movies) {
                flag = 0;
                Log.e("DetailActivity", "movies size " + movies.size());
                for (int j = 0; j < movies.size(); j++) {
                    Log.e("DetailActivity", "loop id " + movies.get(j).getId());
